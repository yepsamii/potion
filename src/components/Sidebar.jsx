...
import { 
  FiSearch, FiSettings, FiTrash2, FiPlus, FiChevronRight, 
  FiChevronDown, FiFile, FiFolder, FiX, FiLogOut, FiHome
} from 'react-icons/fi'
...
export default function Sidebar({ isOpen, onToggle }) {
  ...
  if (!isOpen) {
    return (
      <div className="hidden lg:block w-2 bg-notion-gray-100 hover:bg-notion-gray-200 transition-colors cursor-pointer" 
           onClick={onToggle} />
    )
  }
